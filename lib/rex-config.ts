...
const PLON: RexClientConfig = {
  ...
  email: {
    ...
    from: (process.env.PLON_FROM_EMAIL ?? "Rex at PlasticOnline <onboarding@resend.dev>").trim(),
    teamEmail: (process.env.PLON_TEAM_EMAIL ?? "sales@hollandplastics.com.au").trim(),
  },
