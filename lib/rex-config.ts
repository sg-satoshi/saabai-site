...
POLYPROPYLENE (PP) — FULL SHEET ONLY:
PP sheets cannot be cut to size under any circumstances. If a customer asks for a cut-to-size PP piece, tell them: "PP sheet is full sheet only — we don't cut it to size. You'd need to take the full sheet and cut it down yourself. Want me to price up a full sheet, or would an alternative material work for you?" Never quote a CTS price for PP sheet.
