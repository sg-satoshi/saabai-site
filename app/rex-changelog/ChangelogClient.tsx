...
const CHANGELOG: Day[] = [
  {
    ...
    entries: [
      ...
      { time: "02:05", tag: "NEW", title: "Add finance.create_invoice write path (Phase 3)" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "18:26", tag: "NEW", title: "Separate discount per fee (setup vs recurring) on products" },
  ...
  },
  {
    date: "16 Jul 2026",
    entries: [
      { time: "07:48", tag: "FIX", title: "Cap UHMWPE cut-to-size at full sheet price + cutting fee" }
    ],
  },
  {
    date: "13 Jul 2026",
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "14:36", tag: "NEW", title: "Add Lot 42 The Willows Yarrawonga — lakefront dual occupancy, 69,990, 5.6% yield" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "15:41", tag: "NEW", title: "Match boconsulting.com.au to Lovable reference CSS" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "22:47", tag: "NEW", title: "Heaven Thai 24 location pages - suburbs within 10km of Worongary & Southport" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "20:58", tag: "NEW", title: "Add The Husband Experience service: cards, FAQ, Sofia prompt" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "13:17", tag: "FIX", title: "Correct 10mm PTFE full sheet price from $1345.19 to $1485.00" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "06:18", tag: "FIX", title: "Remove expand from subscriptions.list, fetch customers separately" },
      ...
      { time: "00:15", tag: "NEW", title: "Add Bulk Post Generator to LinkedIn admin page" },
      { time: "00:10", tag: "FIX", title: "Add POST handler to queue routes, include time in scheduledFor" },
  ...
  },
  {
    ...
    entries: [
      ...
      { time: "23:52", tag: "FIX", title: "Switch xAI image model to aurora (grok-2-image-1212 returns 404)" },
      ...
      { time: "22:33", tag: "FIX", title: "Hide NewsTicker signal bar on /for-law-firms page" },
      ...
      { time: "20:47", tag: "FIX", title: "Lazy-init Resend client to prevent build-time module crash" },
      ...
      { time: "14:38", tag: "FIX", title: "Use transparent logo on /for-law-firms dark nav" },
      ...
      { time: "10:20", tag: "NEW", title: "Add payment card logos to /for-law-firms pricing section" },
      ...
      { time: "09:58", tag: "NEW", title: "Add unlimited seats + BYOAK model to /for-law-firms pricing" },
      { time: "09:51", tag: "FIX", title: "Prevent lex demo iframe from auto-scrolling counsel page on load" },
      { time: "09:41", tag: "NEW", title: "Add law-firm ROI calculator to /for-law-firms; fix Lex chat scroll propagation" },
      { time: "09:34", tag: "NEW", title: "/for-law-firms — Lex sales page for law firms" }
    ],
  },
  {
    date: "25 Apr 2026",
