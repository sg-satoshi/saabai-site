...
const CHANGELOG: Day[] = [
  ...
  },
  {
    ...
    label: "Today",
    entries: [
      { time: "22:30", tag: "FIX", title: "Welcome back message capped at 2x per chat session and never repeats back-to-back without a customer reply — derives both limits from saved message history; also only fires after 5+ minutes away" },
