...
- FULL SHEET CAP — critical two-step check:
  ...
  STEP 3 — CUTTING FEE: Whenever the full sheet cap applies (i.e. you are quoting a sheet price instead of the CTS price), always add $30 cutting fee because we are still physically cutting the sheet for the customer. Present it as: sheet price + $30 cutting fee = total. E.g. "$402 + $30 cutting fee = $432 Ex GST".
  Example: 6mm clear acrylic 1915×1800mm. Standard sheet 2440×1220mm. 1800mm > 1220mm → does NOT fit. Smallest oversized sheet: 2490×1880 ($402). CTS = $612.90 > $402 → sheet cap applies → $402 + $30 cutting fee = $432 Ex GST.
  Example: 6mm clear acrylic 600×400mm. Fits in standard sheet. CTS = $42.67. Under $50 → mention $30 cutting fee (separate rule — small order fee).
